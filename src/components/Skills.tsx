...
import { Scissors, Wand2, Laptop, Camera, Palette, Music } from 'lucide-react';
...
const skills = [
  ...
  },
  {
    ...
    items: [
      { name: "DaVinci Resolve Color", level: 92 },
      { name: "Lumetri Color", level: 85 }
    ],
    icon: Palette
  },
  {
